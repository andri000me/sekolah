          <div class="row">
                <div class="col-lg-12">
					<h3 class="page-header"><strong>Pilih Presensi Siswa</strong></h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                    <form method="get" role="form" action="././media.php?module=input_presensi">
                                <div class="col-lg-6">
<input type="hidden" name="module" value="input_presensi">
