          <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><strong>Data Ekstrakulikuler Per-Kelas</strong></h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Pilih Kelas dan Pilih Tahun Ajaran
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                    <form method="get" role="form" action="././media.php?module=ekstrakulikuler" id="myformpilihekstrakulikuler" onSubmit="return validasi_pilihekstrakulikuler()">


                                <div class="col-lg-6">
<input type="hidden" name="module" value="ekstrakulikuler">
