          <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><strong>Pilih Laporan Rapor Siswa</strong></h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                    <form method="get" role="form" action="././media.php?module=laporan_raporsiswa" id="myforminputrapor" 
                                    onSubmit="return validasi_inputrapor()">


                                <div class="col-lg-6">
<input type="hidden" name="module" value="laporan_raporsiswa">
