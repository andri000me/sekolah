...
<div style="page-break-before:always;"></div>
                      ...
                      <table class="heading" style="width:100%;">
        <tr>
        <td> <center><p style="text-align:center; font-size: 16px; font-weight:bold;">RAPOR DAN PROFIL PESERTA DIDIK</p></center></td>
        </tr>
    </table>
    <div class="container">
                      <table><br>
...
<table width='234' border='0  '>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td width="234" colspan='1' align='center'>Guru Kelas</td>
  </tr>
  <tr>
    <td height='68'>&nbsp;</td>
    <td>&nbsp;</td>
