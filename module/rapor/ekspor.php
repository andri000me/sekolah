...
?>
    <div class="container">
        ...
        <?php
            ...
            //SQL data mapel
            $sqlmp=mysqli_query($koneksi,"SELECT * FROM rapor_pengetahuan INNER JOIN rapor_keterampilan WHERE rapor_pengetahuan.nis=rapor_keterampilan.nis AND rapor_pengetahuan.nis='$_GET[nis]'");
        ...
        //SQL data wali
                $sqlwk=mysqli_query($koneksi,"SELECT * FROM walikelas WHERE nama='$_GET[wali]'");
                $hslwk=mysqli_fetch_array($sqlwk);
                
                //SQL data kepala sekolah
                $sqlks=mysqli_query($koneksi,"SELECT * FROM sekolah WHERE nama_sekolah='$_GET[nama_sekolah]'");
                $hslks=mysqli_fetch_array($sqlks);
                    ...
                    <div class='col-md-12'>
                        <table width='100%' border='0px'>
                            <tr>
                                ...
                                <td align='center'>
                                    Sleman, 26 November 2019<br>
                                    Wali Kelas
                                    <br><br><br><br><br>
                                    $hslwk[nama_lengkap]<br>
                                    NIP. $hslwk[nip]
                                </td>
                            </tr>
                            <tr>
                                <td colspan='2' align='center'>
                                    ...
                                    Kepala Sekolah
                                    <br><br><br><br><br>
                                    $hslks[nama_kepala]<br>
                                    NIP. $hslks[nip_kepala]
                                </td>
                            </tr>
                        </table>
                    </div>
