                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                    <form method="get" role="form" action="././media.php?module=data_raporsiswa" id="myforminputrapor" 
                                    onSubmit="return validasi_inputrapor()">


                                <div class="col-lg-6">
<input type="hidden" name="module" value="data_raporsiswa">
...
?>       
  ...
  <?php 
  if($_SESSION['level']=="walikelas"){
    $sql=mysqli_query($koneksi,"SELECT * FROM mapel WHERE idk='$_SESSION[idk]'");
  }else{
