...
<?php
    $sqla=mysqli_query($koneksi,"SELECT * FROM sekolah WHERE nama_sekolah='$_GET(,,,$_SESSION,,,)[nama_sekolah]'");
...
<?php
$sqlw=mysqli_query($koneksi,"SELECT * FROM rapor_langsung WHERE id_raporlangsung='$_GET[id_rapor]'");
...
<?php
$sqlw=mysqli_query($koneksi,"SELECT * FROM rapor_langsung WHERE ids='$_GET[id_rapor]'");
$rsw=mysqli_fetch_array($sqlw);
?>
