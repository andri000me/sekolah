...
?>                                        <tr class="odd gradeX">
                                       ...
                                       <td class="text-center">
                                        <a href="./././cetak.php?module=cetak_raportu&nama_sekolah=<?php echo $rsb['nama_sekolah'] ?>&nama_kelas=<?php echo $rsw['nama_kelas'] ?>&ids=<?php echo $rs['ids'] ?>&tahun_ajaran=<?php echo $rs['tahun_ajaran'] ?>">
