          <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><strong>Data Mata Pelajaran Per-Kelas</strong></h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                    <form method="get" role="form" action="././media.php?module=mapel" id="myformpilihmapel" onSubmit="return validasi_pilihmapel()">


                                <div class="col-lg-6">
<input type="hidden" name="module" value="mapel">
