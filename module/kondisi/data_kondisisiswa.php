...
?>                                        <tr class="odd gradeX">
                                        ...
                                        <a href="./././media.php?module=lihat_kondisi&act=input&nama_sekolah=<?php echo $rsb['nama_sekolah'] ?>&nama_kelas=<?php echo $rsw['nama_kelas'] ?>&nis=<?php echo $rs['nis'] ?>&tahun_ajaran=<?php echo $rs['tahun_ajaran'] ?>">
                                        <button type="button" class="btn btn-primary">Lihat Pelengkap
                                        </button> </a>
