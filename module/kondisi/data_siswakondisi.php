...
while($rs=mysqli_fetch_array($sql)){
        ...
        $sqlc=mysqli_query($koneksi,"SELECT * FROM rapor_kondisi WHERE ids='$rs[ids]'");
...
?>                                        <tr class="odd gradeX">
                                        ...
                                        <a href="./././media.php?module=input_kondisi&act=input&nama_sekolah=<?php echo $rsb['nama_sekolah'] ?>&nama_kelas=<?php echo $rsw['nama_kelas'] ?>&ids=<?php echo $rs['ids'] ?>&tahun_ajaran=<?php echo $rs['tahun_ajaran'] ?>">
                                        <button type="button" class="btn btn-primary">Input Pelengkap
                                        </button> </a>
                                        <a href="./././media.php?module=input_kondisi&act=edit&idrk=<?php echo $rsc['idrk'] ?>">
                                        <button type="button" class="btn btn-warning" onclick="return confirm('Apakah anda yakin mengedit data ini ?');">Edit Pelengkap
                                        </button> </a>
