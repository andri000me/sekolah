...
?>                                        <tr class="odd gradeX">
                                       ...
                                       <a href="./././media.php?module=lihat_prestasi&nis=<?php echo $rs['nis'] ?>&tahun_ajaran=<?php echo $rs['tahun_ajaran'] ?>"><button type="button" class="btn btn-primary">LihatPrestasi
                                        </button> </a>
